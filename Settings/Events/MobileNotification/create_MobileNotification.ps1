...
if ($dataConfig) {
    ...
    try {
        ...
        if ($WorkSheet1) {
            $WorkSheet5 = $WorkBook.sheets.item($mobilenotiresultSheet)
            $worksheet5.delete()
        }
    ...
    $resultSheet.Name = "MobileNoti-Result"
    ...
    # $resultSheet.Cells.Item(1, 5) = 'ToPM'
    # $resultSheet.Cells.Item(1, 6) = 'ToTaskCreator'
    # $resultSheet.Cells.Item(1, 7) = 'ToTaskAssignee'
    # $resultSheet.Cells.Item(1, 8) = 'ToTaskMentioned'
    # $resultSheet.Cells.Item(1, 5).Interior.ColorIndex = 19
    ...
    foreach ($data in $dataExcel) {
        ...
        $dataActivity.Add("actionType", "PUSH_NOTIFICATION")
        ...
        #         $resultSheet.Cells.Item($countToPM, 5) = $data.ToPM
        #         $countToPM++
        #     }
        ...
        # else {
        #     $dataActivity.action.to.Add("projectManager", $false)
        #     $resultSheet.Cells.Item($countToPM, 5) = ""
        #     $resultSheet.Cells.Item($countToPM, 5).Interior.ColorIndex = 15
        #     $countToPM++
        # }
        ...
        #         $resultSheet.Cells.Item($countToTaskCreator, 6) = $data.ToTaskCreator
        #         $countToTaskCreator++
        #     }
        #     elseif ($data.ToTaskMentioned -and $data.when -eq 'Mentioned in a comment') {
        #         $resultSheet.Cells.Item($countToTaskCreator, 6) = $data.ToTaskCreator
        ...
        # else {
        #     $dataActivity.action.to.Add("whoCreateTask", $false)
        #     $resultSheet.Cells.Item($countToTaskCreator, 6) = ""
        #     $resultSheet.Cells.Item($countToTaskCreator, 6).Interior.ColorIndex = 15
        #     $countToTaskCreator++
        # }
        ...
        #         $resultSheet.Cells.Item($countToTaskAssignee, 7) = $data.ToTaskAssignee
        #         $countToTaskAssignee++
        #     }
        #     elseif ($data.ToTaskMentioned -and $data.when -eq 'Mentioned in a comment') {
        #         $resultSheet.Cells.Item($countToTaskAssignee, 7) = $data.ToTaskAssignee
        ...
        # else {
        #     $dataActivity.action.to.Add("whoAssignedTask", $false)
        #     $resultSheet.Cells.Item($countToTaskAssignee, 7) = ""
        #     $resultSheet.Cells.Item($countToTaskAssignee, 7).Interior.ColorIndex = 15
        #     $countToTaskAssignee++
        # }
        ...
        #         $dataActivity.action.to.Add("whoMentioned", $true)
        #         $resultSheet.Cells.Item($countToTaskMentioned, 8) = $data.ToTaskMentioned
        ...
        #     $resultSheet.Cells.Item($countToTaskMentioned, 8) = ""
        #     $resultSheet.Cells.Item($countToTaskMentioned, 8).Interior.ColorIndex = 15
        #     $countToTaskMentioned++
        # }
