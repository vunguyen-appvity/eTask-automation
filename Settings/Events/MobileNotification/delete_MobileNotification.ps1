...
switch ($msgBoxInput) {
    ...
    'Yes' {
        ...
        Write-Host "============================"
        Write-Host "Total mobile notifications have been deleted: $Succeed" -ForegroundColor Green
        Write-Host "Total mobile notifications have been failed to delete: $Failed" -ForegroundColor Red
