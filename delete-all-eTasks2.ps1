$channelName = "Vu Channel 170622 - 02"

Add-Type -AssemblyName PresentationFramework

$msgBoxInput =  [System.Windows.MessageBox]::Show("This action will delete all Tasks in $channelName, Would you like to continue?",'ACTION WARNING !!!','YesNo','Error')
